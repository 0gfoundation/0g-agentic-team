// start-member.js — first provision of a mint-only member (testnet)
// Billing starts at this moment (2c4g tier). API key is read from the lead's sealed
// config file directly (file-level, never printed) and rides an encrypted envelope
// into the member's TEE — the attestor never stores it.
